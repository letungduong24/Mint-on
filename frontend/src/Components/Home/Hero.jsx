...
const Hero = () => {
  ...
  return (
    <div id='hero'>
        <div style={bg} className="relative w-full h-screen flex">
          ...
          <div className="z-10 w-full flex items-center lg:items-end justify-center lg:mr-10 flex-col space-y-2">
            ...
            <Link className='text-white px-3 py-2 bg-white/5 backdrop-blur-xs border border-white/20 rounded-2xl cursor-pointer hover:scale-105 transition-all duration-300 hover:bg-cyan-200/30' to='services' smooth={true} duration={1000}>Khám phá</Link>
          </div>
        </div>
    </div>
  )
